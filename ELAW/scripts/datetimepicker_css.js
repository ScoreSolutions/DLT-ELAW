...
var SpanBorderColor = "#CAEBF4"; //span border color
...
var MonthYearColor = "#015367"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#015367"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#CAEBF4"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#CAEBF4"; //Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor = "#00A6A6"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#00DDFF"; //var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#CCFFFF"; //color when mouse move over.
...
function RenderCssCal(bNewCal) {
	...
	if (Cal.Scroller=="DROPDOWN") {
		...
		//Year selector
		StartYear=dtToday.getFullYear()-5;

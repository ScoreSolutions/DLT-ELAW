...
Partial Class Src_ContractCancel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ViewState("sortfield") = "cancel_name"
        ...
        Else
            If Session("contract_cancel") Is Nothing Then
                Me.gData()
            Else
                DV = Session("contract_cancel")
            End If
        End If
    End Sub
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 cancel_id FROM contract_cancel "
        sqlTmp &= " ORDER BY cancel_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("cancel_id")
    ...
    Private Sub gData() 'ฟังก์ชั่นการเรียกข้อมูลมาแสดง
        ...
        strsql = "select c.cancel_id,c.cancel_name,e.firstname+' '+e.lastname creation_by,c.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,c.updated_date "
        strsql &= " from contract_cancel c inner join employee e "
        ...
        If txtStatus.Text <> "" Then
            strsql &= " and cancel_name like '%" & txtStatus.Text & "%'"
        End If
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from contract_cancel where cancel_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            Me.ClearAlert()
            lblContractCancel.Text = "กรุณากรอกสาเหตุการยกเลิกสัญญา"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                strsql = "update contract_cancel set "
                strsql &= "cancel_name=?,updated_by=?,updated_date=? "
                strsql &= "where cancel_id=?"
        ...
        Else
            ...
            Try
                strsql = "insert into contract_cancel (cancel_id,cancel_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"

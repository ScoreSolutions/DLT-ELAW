...
Partial Class Src_BookType
    ...
    Private Sub ChkPermis() 'ฟังก์ชั่นการตรวจสอบสิทธิ์ฟังก์ชั่นการเข้าใช้
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ViewState("sortfield") = "booktype_name"
        ...
        Else
            If Session("book_type") Is Nothing Then
                Me.gData()
            Else
                DV = Session("book_type")
            End If
        End If
    End Sub
    ...
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 booktype_id FROM book_type "
        sqlTmp &= " ORDER BY booktype_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("booktype_id")
    ...
    Private Sub gData() 'ฟังก์ชั่นการเรียกข้อมูลมาแสดง
        ...
        strsql = "select b.booktype_id,b.booktype_name,e.firstname+' '+e.lastname creation_by,b.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,b.updated_date "
        strsql &= " from book_type b inner join employee e "
        strsql &= " on b.creation_by=e.empid "
        strsql &= " inner join employee e1 "
        strsql &= " on b.updated_by=e1.empid "

        If txtStatus.Text <> "" Then
            strsql &= " and booktype_name like '%" & txtStatus.Text & "%'"
        End If
        ...
        Session("book_type") = DV
    End Sub

    Private Sub MyGridBind()
        'ฟังก์ชั่นการแสดงข้อมูลในตาราง
        GridView1.DataSource = DV
        Dim X1() As String = {"booktype_id"}
        GridView1.DataKeyNames = X1
        GridView1.DataBind()
    End Sub

    Protected Sub GridView1_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GridView1.PageIndexChanging
        'ฟังก์ชั่นการเลือกเปลี่ยนหน้าของข้อมูล
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        'ฟังก์ชั่นการสร้างลิ้งเปลี่ยนหน้าข้อมูล
    ...
    Private Sub GoPage(ByVal xPage As Integer)
        'ฟังก์ชั่นการเปลี่ยนหน้าของข้อมูล
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from book_type where booktype_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            Me.ClearAlert()
            lblBookType.Text = "กรุณากรอกประเภทหนังสือ"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            'ฟังก์ชั่นการบันทึกข้อมูลเมื่อมีการแก้ไข
            Try
                strsql = "update book_type set "
                strsql &= "booktype_name=?,updated_by=?,updated_date=? "
                strsql &= "where booktype_id=?"
        ...
        Else
            ...
            Try
                strsql = "insert into book_type (booktype_id,booktype_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"
    ...
    Protected Sub bCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bCancel.Click
        'ยกเลิกฟังก์ชั่นการบันทึกข้อความ
        txtStatus.Text = ""
        lblStatus.Text = ""
        lblBookType.Text = ""

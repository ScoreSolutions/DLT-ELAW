...
Partial Class Src_BookInCloseJob
    ...
    Dim DS As DataSet
    Dim iRec As Integer
    Const menuID As Integer = Constant.MenuID.BookInCloseJob
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            '1 wutt แก้เรื่อง Session หาย 
            If Session("EmpNo") IsNot Nothing Then
                hdfEmpNo.Value = Session("EmpNo")
            Else
        ...
        Else
            If Session("BookInCloseJob") Is Nothing Then
                Me.gData()
            Else
                DVLst = Session("BookInCloseJob")
            End If
        End If
    End Sub
    ...
    Private Sub gData(Optional ByVal Type As String = "")
        ...
        '2 wutt แก้เรื่อง Session หาย 
        'Dim sEmpNo As String = Session("EmpNo")
        Dim sEmpNo As String = hdfEmpNo.Value
        '--------------------------
        ...
        strsql &= "and b.status_id = 4"
        strsql &= "and b.sendto2='" & sEmpNo & "'"
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Response.Redirect("../Src/BookInCloseJobDetail.aspx?id=" & K1(0) & "&menu=5")
    End Sub

<%@ Page Title="ประเภทคดี-LAW7106" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CaseType.aspx.vb" Inherits="Src_CaseType" %>
        ...
        cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="sslbl">
                        ...
                        &nbsp;
                        <asp:Label ID="lblCaseType" runat="server" CssClass="sslbl_red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="sslbl">
                    ...
                    AllowPaging="True" Width="100%">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="รหัส" SortExpression="ref_no">
                                 <EditItemTemplate>
                                        <asp:TextBox ID="Textno" runat="server" 
                                            Text='<%# Bind("ref_no") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Labelno" runat="server" 
                                            Text='<%# Bind("ref_no") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

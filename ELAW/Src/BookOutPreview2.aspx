<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="BookOutPreview2.aspx.vb" Inherits="Src_BookOutPreview2" %>
        ...
        border="0" width="200">
                ...
                <td class="HeaderGreen" colspan="2">
                    <asp:LinkButton ID="linkHome" runat="server">Home</asp:LinkButton>
                     &nbsp;&gt;
                                    ...
                                    &nbsp;&gt;
                                    <asp:LinkButton ID="link2" runat="server">ข้อมูลหนังสือนำส่ง</asp:LinkButton>
                    &nbsp;&gt;
            ...
            <tr>
                ...
                <td class="sslbl" width="85%">
                    <asp:Label ID="lblRno" runat="server"><%#BindField("runno")%> 
                </asp:Label>
                </td>
            </tr>
            <tr>
            ...
            เนื้อความ :</td>
                <td class="sslbl" >
                    <asp:Label ID="lblMessage" runat="server" Width="750px"><%#BindField("message")%></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style1">
            ...
            <tr>
                <td class="style1">
                    ความเห็น :</td>
                <td class="sslbl" >
                    <asp:Label ID="lblApp1" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style1">
                    บันทึก :</td>
                <td class="sslbl" >
                    <asp:Label ID="lblApp1Comment" runat="server"><%#BindField("sendto_comment")%></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="HeaderGreen" colspan="2">
                    ความเห็นผู้อำนวยการ</td>
            </tr>
            <tr>
                <td class="style1">
                    ความเห็น :</td>
                <td class="sslbl" >
                    <asp:Label ID="lblApp2" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style1">
                    บันทึก :</td>
                <td class="sslbl" >
                    <asp:Label ID="lblApp2Comment" runat="server"><%#BindField("sendto_comment1")%></asp:Label>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="sslbl_right" >
                                            <asp:LinkButton ID="lnkPrint" runat="server" Visible="False">พิมพ์หนังสือนำส่ง</asp:LinkButton>

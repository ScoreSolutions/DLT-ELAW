...
Partial Class Src_Prefix
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ViewState("sortfield") = "prefix_name"
        ...
        Else
            If Session("prefix") Is Nothing Then
                Me.gData()
            Else
                DV = Session("prefix")
            End If
    ...
    Private Sub gData()
        ...
        strsql = "select p.prefix_id,p.prefix_name,e.firstname+' '+e.lastname creation_by,p.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,p.updated_date "
        strsql &= " from prefix p inner join employee e "
        ...
        If txtStatus.Text <> "" Then
            strsql &= " where prefix_name like '%" & txtStatus.Text & "%'"
        End If
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            MC.MessageBox(Me, "กรุณากรอกคำนำหน้าชื่อ")
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            'Edit Data
            Try
                strsql = "update prefix set "
                strsql &= "prefix_name=?,updated_by=?,updated_date=? "
                strsql &= "where prefix_id=?"

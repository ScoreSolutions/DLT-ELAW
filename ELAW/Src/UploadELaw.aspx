<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="UploadELaw.aspx.vb" Inherits="UploadELaw" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;">
            <tr>
                <td class="HeaderGreen"><b title="อัพโหลดบทความ">อัพโหลดบทความ</b></td>
            </tr>
            </table> 

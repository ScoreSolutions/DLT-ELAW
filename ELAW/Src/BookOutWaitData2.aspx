<%@ Page Title="รอตรวจสอบ-LAW6105" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="BookOutWaitData2.aspx.vb" Inherits="Src_BookOutWaitData2" %>
        ...
        border="0" width="200">
            ...
            <tr>
                ...
                <td class="sslbl" >
                    <asp:RadioButtonList ID="rdoApp" runat="server" CssClass="sslbl" 
                        ...
                        <asp:ListItem Value="F">ส่งให้นิติกรแก้ไข</asp:ListItem>
                        <asp:ListItem Value="H">ส่งให้หัวหน้างานแก้ไข</asp:ListItem>
                    </asp:RadioButtonList>
            ...
            <tr>
                <td class="style1">
                    บันทึก :</td>
                <td class="sslbl" >
                    <asp:TextBox ID="txtComment" runat="server"  Text='<%# BindField("sendto_comment1") %>' 

<%@ Page Title="ปรับปรุงสถานะคดี-LAW3209" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CaseStatusList.aspx.vb" Inherits="Src_CaseStatusList" %>
        ...
        <ContentTemplate>
            <table class="form" border="0" cellpadding="1" cellspacing="1">
                <tr>
                    ...
                    &nbsp;&gt;
                    <asp:LinkButton ID="link2" runat="server">ปรับปรุงสถานะคดี</asp:LinkButton>
                    </td>
                </tr>
                <tr>

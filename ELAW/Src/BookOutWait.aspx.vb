...
Partial Class Src_BookOutWait
    ...
    Dim DS As DataSet
    Dim iRec As Integer
    Const menuID As Integer = Constant.MenuID.BookOutWait
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Session("BookOutRunNoList") Is Nothing Then
                Me.gData()
            Else
                DVLst = Session("BookOutRunNoList")
            End If
    ...
    Private Sub gData(Optional ByVal Type As String = "")
        ...
        strsql &= " b.status_id,s.status_name,b.topic,b.keyword,b.dates,b.dates,e.firstname+' '+e.lastname createname, "
        strsql &= " case when b.status_id =7 then b.sendto else b.sendto1 end app "
        ...
        strsql &= " on b.status_id =a.status_id and a.menu_id =58 and a.status_id in (7,8) "
        strsql &= " where(b.active = 1 "
        strsql &= " and b.status_id in (7,8) "
        strsql &= " and case when b.status_id =7 then b.sendto else b.sendto1 end='" & sEmpNo & "' "
        strsql &= " or (a.assign_from = case when b.status_id =7 then b.sendto else b.sendto1 end and a.assign_to ='" & sEmpNo & "' and b.active =1 "
        ...
        Session("BookOutRunNoList") = DVLst
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        If DVLst.Table.Rows(0).Item("status_id").ToString = "7" Then
            Response.Redirect("../Src/BookOutWaitData.aspx?id=" & K1(0) & "&menu=6")
        Else
            Response.Redirect("../Src/BookOutWaitData2.aspx?id=" & K1(0) & "&menu=6")
        End If

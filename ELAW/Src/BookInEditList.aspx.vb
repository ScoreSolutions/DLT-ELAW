...
Partial Class Src_BookInEditList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Session("BookInEditList") Is Nothing Then
                Me.gData()
            Else
                DVLst = Session("BookInEditList")
            End If
    ...
    Private Sub gData(Optional ByVal Type As String = "")
        ...
        strsql &= "b.status_id,s.status_name,b.topic,b.keyword,b.recieve_date,b.from_name,right(b.runno,4) runno "
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not e.Row.RowState And DataControlRowState.Edit Then
                Dim L1 As LinkButton = e.Row.Cells(8).Controls(1)
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Response.Redirect("../Src/BookInData.aspx?id=" & K1(0) & "&status=edit&menu=5")
    End Sub
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        sql = "update bookin_data set active=0,updated_by='" & sEmpNo & "',updated_date=getdate() where bookin_id='" & K1(0).ToString & "'"

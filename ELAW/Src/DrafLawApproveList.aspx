<%@ Page Title="ร่างกฎหมายรอพิจารณา-LAW2204" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="DrafLawApproveList.aspx.vb" Inherits="Src_DrafLawApproveList" %>
        ...
        <ContentTemplate>
            <table class="form" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                 ...
                 <tr>
                    <td class="sslbl_right">นิติกรเจ้าของเรื่อง</td>
                    <td>
                        <uc2:TextBox ID="txtLawerName" runat="server" IsNotNull="false" TextKey="TextChar" Width="600" />
                    </td>
                </tr>
                <tr>

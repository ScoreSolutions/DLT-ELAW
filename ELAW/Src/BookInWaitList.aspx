<%@ Page Title="รอจ่ายงาน-LAW5202" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="BookInWaitList.aspx.vb" Inherits="Src_BookInWaitList" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="recieve_date" 
                        DataFormatString="{0:dd/MM/yyyy HH:mm}" HeaderText="วันที่รับเรื่อง" 

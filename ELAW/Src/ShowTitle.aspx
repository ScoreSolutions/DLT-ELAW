<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowTitle.aspx.vb" Inherits="Src_ShowTitle" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>เลือกงาน</title>
        ...
        cellspacing="1" width ="100%">
                ...
                <tr>
                    <td  bgcolor="#EBF1F3" class="sslbl_right">
                        ประเภท</td>
                    <td  bgcolor="#EBF1F3">
                    <asp:DropDownList ID="ddlBookType" runat="server" CssClass="ssddl" Width="255px">
                    </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    AllowPaging="True" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ประเภท" SortExpression="link_type" >
                                   
                                    <ItemTemplate>
                                        <asp:Label ID="lbltype" runat="server" Text='<%# Bind("link_type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                               <asp:BoundField DataField="name" HeaderText="เรื่อง" SortExpression="name" />

...
Partial Class Src_ShowCase
    ...
    Dim DS As DataSet
    Dim iRec As Integer
    Dim TextCase As String
    Dim TextIdCase As String

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        TextIdCase = Request.QueryString("id")
        TextCase = Request.QueryString("name")
        ...
        Else
            If Session("searchCase") Is Nothing Then
                Me.gData()
            Else
                DV = Session("searchCase")
            End If
        End If
    End Sub
    Public Sub DataType()
    ...
    Private Sub gData(Optional ByVal X As String = "", Optional ByVal xType As String = "S")
        ...
        strsql = "select d.case_id,'คดีดำ : '+d.black_no+' คดีแดง : '+d.red_no all_no,t.type_name   "
        strsql &= " from case_data d inner join case_type t "
        strsql &= " on d.type_id=t.type_id "
        strsql &= " where d.active=1"

        If ddlType.SelectedValue <> "0" Then
            strsql &= " and d.type_id='" & ddlType.SelectedValue & "'"
        End If

        If txtName.Text <> "" Then
            strsql &= " and d.black_no like '%" & txtName.Text & "%' or d.red_no like '%" & txtName.Text & "%' "
        End If
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        Try
            ...
            If e.CommandName = "SelectTitle" Then
                ...
                Session(TextIdCase) = pName
                Session(TextCase) = pValue
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            DirectCast(e.Row.Cells(3).Controls(1), LinkButton).CommandArgument = DirectCast(e.Row.Cells(2).Controls(1), Label).Text

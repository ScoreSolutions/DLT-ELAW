<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="BookStatus.aspx.vb" Inherits="Src_BookStatus" title="สถานะหนังสือ-LAW7110" %>
        ...
        cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="sslbl">
                        ...
                        &nbsp;
                        <asp:Label ID="lblBookStatus" runat="server" CssClass="sslbl_red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style8">&nbsp;
                ...
                <tr>
                    <td colspan="2" width="100%">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="สถานะหนังสือ" SortExpression="status_name">
                                    <EditItemTemplate>

<%@ Page Title="ประเภทย่อยกฎหมาย-LAW7112" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="LawSubtype.aspx.vb" Inherits="Src_LawSubtype" %>
        ...
        cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="sslbl">
                        ...
                        &nbsp;
                        <asp:Label ID="lblLawSubtype" runat="server" CssClass="sslbl_red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style7">&nbsp;
                    ...
                    <td colspan="2" width="100%">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ประเภทกฎหมาย" SortExpression="type_name">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="ประเภทย่อยกฎหมาย" SortExpression="subtype_name">
                                    <EditItemTemplate>

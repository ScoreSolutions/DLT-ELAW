...
Partial Class Src_BookPriority
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ViewState("sortfield") = "priority_name"
        ...
        Else
            If Session("priority_type") Is Nothing Then
                Me.gData()
            Else
                DV = Session("priority_type")
            End If
        End If
    End Sub
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 priority_id FROM book_priority "
        sqlTmp &= " ORDER BY priority_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("priority_id")
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from book_priority where priority_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            ...
            Me.ClearAlert()
            lblBookPriority.Text = "กรุณากรอกระดับความสำคัญของหนังสือ"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                strsql = "update book_priority set "
                strsql &= "priority_name=?,updated_by=?,updated_date=? "
                strsql &= "where priority_id=?"
        ...
        Else
            ...
            Try
                strsql = "insert into book_priority (priority_id,priority_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"

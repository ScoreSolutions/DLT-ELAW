...
Partial Class Src_ContractSubtype
    ...
    Function GetRefNo() As String
        Dim str As String
        Dim oDs As DataSet
        str = "select * from Contract_Type where type_id='" & ddlContractType.SelectedValue & "'"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Session("contract_subtype") Is Nothing Then
                Me.gData()
            Else
                DV = Session("contract_subtype")
            End If
        End If
    End Sub
    Private Sub Auto()
        ...
        sqlTmp = "SELECT TOP 1 subtype_id FROM contract_subtype "
    ...
    Public Sub DataContractType()
        ...
        ddlContractType.DataTextField = "type_name"
        ddlContractType.DataValueField = "type_id"
        ddlContractType.DataSource = DTS
    ...
    Private Sub gData()
        ...
        Dim strsql As String
        strsql = "select c.type_id,c.subtype_id,c.subtype_name,e.firstname+' '+e.lastname creation_by,c.created_date, "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,c.updated_date,c1.type_name  "
        strsql &= " from contract_subtype c inner join employee e  "
        strsql &= " on c.creation_by=e.empid "
        strsql &= " inner join employee e1 "
        strsql &= " on c.updated_by=e1.empid "
        strsql &= " inner join contract_type c1 "
        strsql &= " on c.type_id = c1.type_id "



        If ddlContractType.SelectedValue <> "0" Then
            strsql &= " and c.type_id='" & ddlContractType.SelectedValue & "' "
        End If



        If txtStatus.Text <> "" Then
            strsql &= " and subtype_name like '%" & txtStatus.Text & "%'"
        End If
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from contract_subtype where subtype_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        ddlContractType.SelectedValue = ldept.Text
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If ddlContractType.SelectedValue = "0" Then
            Me.ClearAlert()
            lblContractType.Text = "กรุณาเลือกประเภทสัญญา"
            Exit Sub
        End If

        If txtStatus.Text.Trim = "" Then
            Me.ClearAlert()
            lblContractSubtype.Text = "กรุณากรอกประเภทย่อยสัญญา"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            'Edit Data
            Try
                strsql = "update contract_subtype set "
                ...
                cmd.Parameters("@P1").Value = ddlContractType.SelectedValue
        ...
        Else
            ...
            Try
                strsql = "insert into contract_subtype (subtype_id,type_id,subtype_name,ref_no,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?,?,?)"
                ...
                cmd.Parameters("@P2").Value = ddlContractType.SelectedValue

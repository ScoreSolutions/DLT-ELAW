...
Partial Class Src_Court
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ViewState("sortfield") = "court_name"
        ...
        Else
            If Session("court_status") Is Nothing Then
                Me.gData()
            Else
                DV = Session("court_status")
            End If
        End If
    End Sub
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1
        ...
        sqlTmp = "SELECT TOP 1 court_id FROM court "
        sqlTmp &= " ORDER BY court_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("court_id")
    ...
    Private Sub gData() 'ฟังก์ชั่นการเรียกข้อมูลมาแสดง
        ...
        strsql = "select c.court_id,c.court_name,e.firstname+' '+e.lastname creation_by,c.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,c.updated_date "
        strsql &= " from court c inner join employee e "
        ...
        If txtStatus.Text <> "" Then
            strsql &= " and court_name like '%" & txtStatus.Text & "%'"
        End If
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from court where court_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            lblCourt.Text = "กรุณากรอกชื่อศาล"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                strsql = "update court set "
                strsql &= "court_name=?,updated_by=?,updated_date=? "
                strsql &= "where court_id=?"
        ...
        Else
            ...
            Try
                strsql = "insert into court (court_id,court_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"

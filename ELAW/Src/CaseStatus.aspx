<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CaseStatus.aspx.vb" Inherits="Src_CaseStatus" title="สถานะคดี-LAW7107" %>
        ...
        cellspacing="1">
                ...
                <tr>
                    <td class="sslbl">
                        ประเภทคดี&nbsp;</td>
                    <td class="sslbl">
                        <asp:DropDownList ID="ddlCasetype" runat="server" CssClass="ssddl" 
                ...
                <tr>
                    ...
                    <td class="sslbl">
                        ...
                        <asp:Label ID="lblAlert1" runat="server" CssClass="sslbl_red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="sslbl">
                ...
                <tr>
                    ...
                    AllowPaging="True" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ประเภทคดี" SortExpression="type_name">
                                <EditItemTemplate>
                                        <asp:TextBox ID="TextType" runat="server" 
                                            Text='<%# Bind("type_name") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="LabelCasetype" runat="server" 
                                            Text='<%# Bind("type_name") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="20%" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="สถานะคดี" SortExpression="status_name">
                                    <EditItemTemplate>

<%@ Page Title="รอพิจารณา-LAW3205" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CaseApproveList.aspx.vb" Inherits="Src_CaseApproveList" %>
            ...
            <table class="form" border="0" cellpadding="1" cellspacing="1">
                <tr>
                    <td class="HeaderGreen" colspan="2">
                        ...
                        &nbsp;&gt;
                        <asp:LinkButton ID="link2" runat="server">รอพิจารณา</asp:LinkButton>
                    </td>
                </tr>
                <tr>

...
Partial Class UploadELaw
    ...
    Sub AutoIDFile()
        ...
        sqlTmp = "SELECT top 1 file_id From File_Upload order by file_id Desc "
    ...
    Protected Sub btnCreateELAW_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreateELAW.Click
        ...
        Dim strPath As String = "FileELaw\"
        ...
        Try
            ...
            Strsql = "insert into File_Upload (file_id,name,Detail,"
            ...
            Response.Redirect("UploadElaw.aspx")
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim strPath As String = Constant.BaseURL(Request) & ("FileELaw\")
        Dim strsql As String
        Dim chk As String

        chk = "select * from File_Upload where file_id=" & K(0).ToString
        Dim DS As DataSet
        Dim mtype As String = ""
        Dim fname As String = ""
        ...
        strsql = "delete from File_Upload where file_id=" & K(0).ToString
        Dim Y As Integer = MD.Execute(strsql)
        If Y > 0 Then
            BindData()

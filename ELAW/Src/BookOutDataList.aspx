<%@ Page Title="ทะบียนหนังสือนำส่ง-LAW6201" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="BookOutDataList.aspx.vb" Inherits="Src_BookOutDataList" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="LnkSelect" runat="server" CommandName="Select">เลือก</asp:LinkButton>
                        </ItemTemplate>

...
Partial Class Src_LawType
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Session("law_type") Is Nothing Then
                Me.gData()
            Else
                DV = Session("law_type")
            End If
    ...
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 type_id FROM law_type "
    ...
    Private Sub gData() 'ฟังก์ชั่นการเรียกข้อมูลมาแสดง
        ...
        strsql = "select l.type_id,l.type_name,e.firstname+' '+e.lastname creation_by,l.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,l.updated_date,l.ref_no "
        strsql &= " from law_type l inner join employee e "
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from law_type where type_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            Me.ClearAlert()
            lblLawType.Text = "กรุณากรอกประเภทกฎหมาย"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        Else
            ...
            Try
                strsql = "insert into law_type (type_id,ref_no,type_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?,?)"

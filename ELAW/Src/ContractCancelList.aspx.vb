...
Partial Class Src_ContractCancelList
    ...
    Dim DS As DataSet
    Dim iRec As Integer
    Const menuID As Integer = Constant.MenuID.ContractCancelList
    ...
    Private Sub gData(Optional ByVal Type As String = "")
        ...
        strsql &= "where d.creation_by='" & sEmpNo & "' "
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Response.Redirect("../Src/ContractPreview.aspx?id=" & K1(0) & "&status=cancel&menu=4")
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        'Hightlight สัญญาที่ยกเลิก
        If e.Row.RowType = DataControlRowType.Header Then
            e.Row.Style.Add(HtmlTextWriterStyle.Position, "relative")
            e.Row.Style.Add(HtmlTextWriterStyle.Top, "expression(this.parentNode.parentNode.parentNode.scrollTop - 1)")
        End If

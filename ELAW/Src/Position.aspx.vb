...
Partial Class Src_Position
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Session("position") Is Nothing Then
                Me.gData()
            Else
                DV = Session("position")
            End If
    ...
    Private Sub Auto()
        ...
        sqlTmp = "SELECT TOP 1 pos_id FROM position "
        sqlTmp &= " ORDER BY pos_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("pos_id")
    ...
    Private Sub gData()
        ...
        Dim strsql As String
        strsql = "select p.pos_id,p.pos_name,e.firstname+' '+e.lastname creation_by,p.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,p.updated_date,d.dept_id,d.dept_name,  "
        strsql &= " d1.div_id,d1.div_name  "
        strsql &= " from position p inner join employee e  "
        strsql &= " on p.creation_by=e.empid "
        strsql &= " inner join employee e1 "
        strsql &= " on p.updated_by=e1.empid "
        strsql &= " inner join department d "
        strsql &= " on p.dept_id = d.dept_id "
        strsql &= " inner join division d1 "
        strsql &= " on p.div_id = d1.div_id "
        ...
        If ddlDiv.SelectedValue <> "0" Then
            strsql &= "and p.div_id='" & ddlDiv.SelectedValue & "' "
        End If

        If txtStatus.Text <> "" Then
            strsql &= " and p.pos_name like '%" & txtStatus.Text & "%'"
        End If
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from position where pos_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Dim ldiv As Label = GridView1.Rows(e.NewEditIndex).Cells(1).Controls(1)
        Dim lname As Label = GridView1.Rows(e.NewEditIndex).Cells(4).Controls(1)

        lblId.Text = K1(0).ToString
        ddlDept.SelectedValue = ldept.Text
        Me.DataDivision()
        ddlDiv.SelectedValue = ldiv.Text 'add
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If ddlDept.SelectedValue = "0" Then
            MC.MessageBox(Me, "กรุณาเลือกหน่วยงาน")
            Exit Sub
        End If

        If ddlDiv.SelectedValue = "0" Then
            MC.MessageBox(Me, "กรุณาเลือกส่วนงาน")
            Exit Sub
        End If


        If txtStatus.Text.Trim = "" Then
            MC.MessageBox(Me, "กรุณากรอกชื่อตำแหน่ง")
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                ...
                strsql &= "dept_id=?,div_id=?,pos_name=?,updated_by=?,updated_date=? "
                strsql &= "where pos_id=?"
                ...
                cmd.Parameters("@P2").Value = ddlDiv.SelectedValue
        ...
        Else
            ...
            Try
                strsql = "insert into position (pos_id,dept_id,div_id,pos_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?,?,?)"
                ...
                cmd.Parameters("@P3").Value = ddlDiv.SelectedValue
                cmd.Parameters("@P4").Value = txtStatus.Text

...
Partial Class Src_UploadCase
    ...
    Sub AutoIDFile()
        ...
        sqlTmp = "SELECT top 1 file_id From Case_Upload order by file_id Desc "
    ...
    Protected Sub btnCreateELAW_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreateELAW.Click
        ...
        Dim strPath As String = "CASEUPLOAD\"
        ...
        Try
            ...
            Strsql = "insert into Case_Upload (file_id,name,Detail,"
            ...
            Strsql &= " values  "
            Strsql &= " ('" & lblID.Text & "','" & txtELAW.Text & "', '" & txtDetail.Text & "'"
            ...
            Response.Redirect("UploadCase.aspx")
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim strPath As String = Constant.BaseURL(Request) & ("CASEUPLOAD\")
        Dim strsql As String
        Dim chk As String

        chk = "select * from Case_Upload where file_id=" & K(0).ToString
        Dim DS As DataSet
        Dim mtype As String = ""
        Dim fname As String = ""
        ...
        strsql = "delete from Case_Upload where file_id=" & K(0).ToString
        Dim Y As Integer = MD.Execute(strsql)
        If Y > 0 Then
            BindData()
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strsql2 = "select * from Case_Upload"

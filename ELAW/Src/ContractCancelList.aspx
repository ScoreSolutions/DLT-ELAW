<%@ Page Title="ยกเลิกสัญญา-LAW4206" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="ContractCancelList.aspx.vb" Inherits="Src_ContractCancelList" %>
            ...
            <table class="form" border="0" cellpadding="1" cellspacing="1">
                <tr>
                    <td class="HeaderGreen" colspan="2">
                        ...
                        &nbsp;&gt;
                        <asp:LinkButton ID="link2" runat="server">ยกเลิกการร่างสัญญา</asp:LinkButton>
                        &nbsp;</td>
                </tr>
                <tr>

<%@ Page Title="บันทึกสถานะสัญญา-LAW7104" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="ContractStatus.aspx.vb" Inherits="Src_ContractStatus" %>
        ...
        cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="sslbl">
                        ...
                        &nbsp;
                        <asp:Label ID="lblContractstatus" runat="server" CssClass="sslbl_red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="sslbl">&nbsp;
                ...
                <tr>
                    <td colspan="2" width="100%">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="สถานะสัญญา" SortExpression="status_name">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("status_name") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>

...
Partial Class Src_ShowContract
    ...
    Dim DS As DataSet
    Dim iRec As Integer
    Dim TextBoxIDContract As String
    Dim TextBoxNameContract As String

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        TextBoxIDContract = Request.QueryString("id")
        TextBoxNameContract = Request.QueryString("name")
        If Not Page.IsPostBack Then

            ViewState("sortfield") = "contract_no"
        ...
        Else
            If Session("searchContract") Is Nothing Then
                Me.gData()
            Else
                DV = Session("searchContract")
            End If
        End If
    End Sub
    Public Sub DataStatus()
        ...
        ddlStatus.DataTextField = "subtype_name"
        ddlStatus.DataValueField = "subtype_id"
    ...
    Private Sub gData(Optional ByVal X As String = "", Optional ByVal xType As String = "S")
        ...
        strsql = "select * from contract_data where active=1 "

        If ddlStatus.SelectedValue <> "0" Then
            strsql &= " and subtype_id='" & ddlStatus.SelectedValue & "'"
        End If

        If txtName.Text <> "" Then
            strsql &= " and contract_name like '%" & txtName.Text & "%' or contract_no like '%" & txtName.Text & "%' "
        End If
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        Try
            ...
            If e.CommandName = "SelectTitle" Then
                ...
                Session(TextBoxIdContract) = item.Text
                Session(TextBoxNameContract) = pName

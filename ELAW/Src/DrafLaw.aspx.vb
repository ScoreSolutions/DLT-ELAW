...
Partial Class Src_DrafLaw
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            If Request.QueryString("type") = "View" Then
                ...
                bSelectTitle.Visible = False
                bDelTitle.Visible = False
            End If
    ...
    Private Sub DataLawType()
        ...
        strsql &= "from law_type order by type_id "
    ...
    Private Sub DataLawSubType()
        ...
        strsql &= "from law_subtype where type_id='" & ddlLawType.SelectedValue & "' order by subtype_id "
    ...
    Private Sub DataLawStatus()
        ...
        'ddlLawStatus.SelectedValue = GetProcessStatus(ddlLawType.SelectedValue)("begin_status").ToString()
    End Sub
    ...
    Protected Sub bSaveSend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSaveSend.Click
        ...
        If ddlSendTo.SelectedValue = "" Then
            ddlSendTo.ValidMsg = "***กรุณาเลือก ส่งต่อเพื่อตรวจ"
            Exit Sub
        End If
        ...
        If SaveData(trans) = True Then
            ...
            Try
                ...
                If ret = True Then
                    trans.Commit()
                    Response.Redirect("../Src/DrafLawList.aspx")
                Else
                    trans.Rollback()
                End If
    ...
    Private Sub BindDrafLawData(ByVal lawID As String)
        ...
        sql += " ld.dates, ld.title, ld.keyword, ld.message, ld.sendto, ld.active, ld.ref_id, ld.note,"
    ...
    Protected Sub gvDocList_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvDocList.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Request.QueryString("type") = "View" Then
                'ซ่อนปุ่ม แก้ไขและปุ่มลบใน Gridview
                gvDocList.Columns(3).Visible = False
                gvDocList.Columns(4).Visible = False
            End If
    ...
    Private Sub gDataLink()
        ...
        strsql &= "where ref_type=1 and ref_id='" & X & "'"
    ...
    Protected Sub GridView4_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView4.RowDataBound
        ...
        '    DirectCast(e.Row.Cells(3).Controls(1), LinkButton).CommandArgument = DirectCast(e.Row.Cells(1).Controls(1), Label).Text
    ...
    Protected Sub link2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles link2.Click
        Response.Redirect("../Src/DrafLawList.aspx", True)
    End Sub

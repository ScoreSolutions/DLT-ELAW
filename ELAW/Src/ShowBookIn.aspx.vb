...
Partial Class Src_ShowBookIn
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Session("searchBookInData") Is Nothing Then
                Me.gData()
            Else
                DV = Session("searchBookInData")
            End If
        End If
    End Sub
    Private Sub gData(Optional ByVal X As String = "", Optional ByVal xType As String = "S")
        ...
        strsql = "select * from bookin_data where status_id not in (1,2,3)  and sendto2='" & sEmpNo & "' "

        If txtName.Text <> "" Then
            strsql &= " and topic like '%" & txtName.Text & "%' or bookin_no like '%" & txtName.Text & "%' "
        End If
        strsql &= " and active=1 "

...
Partial Class Src_CaseDecisionList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Session("CaseDecisionList") Is Nothing Then
                Me.gData()
            Else
                DVLst = Session("CaseDecisionList")
            End If
    ...
    Private Sub gData(Optional ByVal Type As String = "")
        ...
        Session("CaseDecisionList") = DVLst
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Response.Redirect("../Src/CaseAttDecision.aspx?id=" & K1(0) & "&no=" & lNo.Text & "&menu=3")
    End Sub
End Class

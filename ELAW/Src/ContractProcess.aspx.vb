...
Partial Class Src_ContractProcess
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ViewState("sortfield") = "process_name"
        ...
        Else
            If Session("contract_process") Is Nothing Then
                Me.gData()
            Else
                DV = Session("contract_process")
            End If
        End If
    End Sub
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 process_id FROM contract_process "
        sqlTmp &= " ORDER BY process_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("process_id")
    ...
    Private Sub gData()
        ...
        strsql = "select c.process_id,c.process_name,e.firstname+' '+e.lastname creation_by,c.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,c.updated_date "
        strsql &= " from contract_process c inner join employee e "
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from contract_process where process_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            lblAlert.Text = "กรุณากรอกวิธีจัดจ้าง"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                strsql = "update contract_process set "
                strsql &= "process_name=?,updated_by=?,updated_date=? "
        ...
        Else
            ...
            Try
                strsql = "insert into contract_process (process_id,process_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"

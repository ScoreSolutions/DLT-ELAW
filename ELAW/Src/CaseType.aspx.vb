...
Partial Class Src_CaseType
    ...
    End Sub
    Private Sub Auto()
        'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 type_id FROM case_type "
        sqlTmp &= " ORDER BY type_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("type_id")
    ...
    End Sub
    Private Sub gData()
        'ฟังก์ชั่นการเรียกข้อมูลมาแสดง
        Dim strsql As String
        strsql = "select c.type_id,c.type_name,e.firstname+' '+e.lastname creation_by,c.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,c.updated_date,c.ref_no "
        strsql &= " from case_type c inner join employee e "
        strsql &= " on c.creation_by=e.empid "
        strsql &= " inner join employee e1 "
        strsql &= " on c.updated_by=e1.empid "
      
        If txtNo.Text <> "" Then
            strsql &= " and ref_no like '%" & txtNo.Text & "%'"
        End If

        If txtStatus.Text <> "" Then
            strsql &= " and type_name like '%" & txtStatus.Text & "%'"
        End If

        Dim DT As DataTable = MD.GetDataTable(strsql)
        DV = DT.DefaultView
        DV.Sort = "[" & ViewState("sortfield") & "] " & ViewState("sortdirection")
        Session("case_type") = DV
    End Sub
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from case_type where type_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Dim lNo As Label = GridView1.Rows(e.NewEditIndex).Cells(0).Controls(1)
        Dim lName As Label = GridView1.Rows(e.NewEditIndex).Cells(1).Controls(1)
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtNo.Text.Trim = "" Then
            Me.ClearAlert()
            lblno.Text = "กรุณากรอกรหัส"
            Exit Sub
        End If

        If txtStatus.Text.Trim = "" Then
            Me.ClearAlert()
            lblCaseType.Text = "กรุณากรอกประเภทคดี"
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                ...
                strsql &= "ref_no=?,type_name=?,updated_by=?,updated_date=? "
        ...
        Else
            ...
            Try
                strsql = "insert into case_type (ref_no,type_id,type_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?,?)"
                ...
                cmd.Parameters("@P1").Value = txtNo.Text
                cmd.Parameters("@P2").Value = lblId.Text

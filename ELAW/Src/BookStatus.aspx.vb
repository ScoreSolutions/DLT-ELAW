...
Partial Class Src_BookStatus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ViewState("sortfield") = "status_name"
            ViewState("sortdirection") = "asc"
            Me.gData() 'เรียกใช้ฟังก์ชั่นการแสดงข้อมูล
            Me.MyGridBind()
        Else
            If Session("book_status") Is Nothing Then
                Me.gData()
            Else
                DV = Session("book_status")
            End If
        End If
    End Sub
    Private Sub Auto() 'ฟังก์ชั่นการกำหนดรหัสของข้อมูลโดยเพิ่มขึ้นจากเดิมทีละ 1 
        ...
        sqlTmp = "SELECT TOP 1 status_id FROM book_status "
    ...
    Private Sub gData() 'ฟังก์ชั่นการเรียกข้อมูลมาแสดง
        ...
        strsql = "select b.status_id,b.status_name,e.firstname+' '+e.lastname creation_by,b.created_date,  "
        strsql &= " e1.firstname+' '+e1.lastname updated_by,b.updated_date "
        strsql &= " from book_status b inner join employee e "
        strsql &= " on b.creation_by=e.empid "
        strsql &= " inner join employee e1 "
        strsql &= " on b.updated_by=e1.empid "

        If txtStatus.Text <> "" Then
            strsql &= " where status_name like '%" & txtStatus.Text & "%'"
        End If
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from book_status where status_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            ...
            Me.ClearAlert()
            lblBookStatus.Text = "กรุณากรอกสถานะหนังสือ"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            ...
            Try
                strsql = "update book_status set "
                strsql &= "status_name=?,updated_by=?,updated_date=? "
        ...
        Else
            ...
            Try
                strsql = "insert into book_status (status_id,status_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"

<%@ Page Title="ชื่อศาล-LAW7105" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="Court.aspx.vb" Inherits="Src_Court" %>
        ...
        cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="sslbl">
                        ...
                        &nbsp;
                        <asp:Label ID="lblCourt" runat="server" CssClass="sslbl_red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style10">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="ชื่อศาล" SortExpression="court_name">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("court_name") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("court_name") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="20%" />
                                </asp:TemplateField>

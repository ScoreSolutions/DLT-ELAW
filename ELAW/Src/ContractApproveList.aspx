<%@ Page Title="สัญญารอลงนาม-LAW4203" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="ContractApproveList.aspx.vb" Inherits="Src_ContractApproveList" %>
            ...
            <table class="form" border="0" cellpadding="1" cellspacing="1">
                <tr>
                    <td class="HeaderGreen" colspan="2">
                        ...
                        &nbsp;&gt;
                        <asp:LinkButton ID="link2" runat="server">สัญญารอลงนาม</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="sslbl_right">
                        คำค้นหา</td>
                    <td>
                        <asp:TextBox ID="txtKeyword" runat="server" CssClass="ssddl" 

...
Partial Class Src_LinkSearch
    ...
    Private Sub gData(Optional ByVal X As String = "", Optional ByVal xType As String = "S")
        ...
        strsql = "select link_id,link_name,detail  "
        strsql &= " from link_download  "
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strsql2 = "select * "
            strsql2 &= "from link_download "
            strsql2 &= "where link_id='" & K2 & "' "
            ...
            For Each dr As DataRow In dt.Rows
                ...
                lblLink.Text += "<a href='//" & dr("link_name").ToString() & "' Target='_Blank'>" & dr("link_name").ToString() & "</a>&nbsp;&nbsp;"

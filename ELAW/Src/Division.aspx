<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="Division.aspx.vb" Inherits="Src_Division" title="ส่วนงาน-LAW9109" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ส่วนงาน" SortExpression="div_name">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("div_name") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="20%" />
                                </asp:TemplateField>

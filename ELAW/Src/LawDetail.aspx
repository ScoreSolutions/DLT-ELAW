<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LawDetail.aspx.vb" Inherits="Src_LawDetail" %>
            ...
            <tr>
                <td class="sslbl" colspan="2">
                    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                        ...
                        CssClass="GridViewStyle" PageSize="2" Width="100%" ForeColor="#333333" 
                        GridLines="None" Visible="False">
                        <RowStyle BackColor="White" />
                        <Columns>
                            
                            <asp:BoundField DataField="subtype_name" HeaderText="ประเภท" ItemStyle-Height="40%">
<ItemStyle Height="32%"></ItemStyle>
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="ชื่อเอกสาร">
                            <ItemTemplate>
                            <asp:Label ID="lblLinkFileMain" runat="server" Font-Bold="False" ForeColor="#330099"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="58%" />
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="ดาวน์โหลด">
                            <ItemTemplate>
                            <asp:Label ID="lblLinkDownloadMain" runat="server" Font-Bold="False" 
        ...
        >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="ชื่อเอกสาร">
                            <ItemTemplate>
                            <asp:Label ID="lblLinkFileDetail" runat="server" Font-Bold="False" ForeColor="#330099"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="90%" />
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="ดาวน์โหลด">

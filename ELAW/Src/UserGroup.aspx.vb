...
Partial Class Src_UserGroup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ViewState("sortfield") = "group_name"
        ...
        Else
            If Session("usergroup") Is Nothing Then
                Me.gData()
            Else
                DV = Session("usergroup")
            End If
        End If
    End Sub
    Private Sub Auto()
        ...
        sqlTmp = "SELECT TOP 1 group_id FROM groupbase "
        sqlTmp &= " ORDER BY group_id DESC"
        ...
        Try
            With comTmp
                ...
                tmpMemberID2 = drTmp.Item("group_id")
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim Y As Integer = MD.Execute("delete from groupbase where group_id ='" & K1(0) & "'")
        If Y = 1 Then
    ...
    Protected Sub bSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bSave.Click
        ...
        If txtStatus.Text.Trim = "" Then
            lblAlert.Text = "กรุณากรอกกลุ่มผู้ใช้งาน"
            txtStatus.Focus()
            Exit Sub
        End If
        ...
        If lblStatus.Text = "Edit" Then
            'Edit Data
            Try
                strsql = "update groupbase set "
                strsql &= "group_name=?,updated_by=?,updated_date=? "
        ...
        Else
            ...
            Try
                strsql = "insert into groupbase (group_id,group_name,creation_by,created_date,updated_by,updated_date)"
                strsql &= " Values (?,?,?,?,?,?)"

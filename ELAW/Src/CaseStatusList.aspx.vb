...
Partial Class Src_CaseStatusList
    ...
    Dim DS As DataSet
    Dim iRec As Integer
    Const menuID As Integer = Constant.MenuID.CaseStatusList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Session("CaseStatusList") Is Nothing Then
                Me.gData()
            Else
                DVLst = Session("CaseStatusList")
            End If
    ...
    Private Sub gData(Optional ByVal Type As String = "")
        ...
        strsql &= "(select step1 from case_process "
        strsql &= "union select step2 from case_process "
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        ...
        '    oTableCell.Text = "คิวการแจ้งซ่อม"
        '    oTableCell.Font.Name = "Arial,Microsoft Sans Serif,Tahoma,sans-serif"
        '    oTableCell.ColumnSpan = 4
        '    oTableCell.HorizontalAlign = HorizontalAlign.Center
        '    oTableCell.ForeColor = Drawing.Color.Black
        '    oTableCell.CssClass = "thclass"
        '    oGridViewRow.Cells.Add(oTableCell)


        '    oTableCell = New TableCell()
        '    oTableCell.Text = "Panel1"
        '    oTableCell.ColumnSpan = 4
        '    oTableCell.HorizontalAlign = HorizontalAlign.Center
        '    oTableCell.CssClass = "thclass"
        '    oGridViewRow.Cells.Add(oTableCell)
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Response.Redirect("../Src/CasePreview.aspx?id=" & K1(0) & "&status=chkstate&menu=3")
    End Sub

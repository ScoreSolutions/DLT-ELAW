...
Partial Class LawDetail
    ...
    Private Sub LoadLaw()
        ...
        strsql &= "where d.doc_id='" & X & "' and d.active=1 and d.secret=0 "
    ...
    Private Sub gData()
        ...
        strsql &= " And im.active = 1 and im.secret=0 "
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strsql = "select d.doc_id,d.doc_type,d.doc_subtype, "
            strsql &= "case when d.cancel=1 then d.doc_name+' (ยกเลิก : '+d.cancel_comment+')' else d.doc_name end doc_name,"
            strsql &= "d.file_path,d.mime_type "
            strsql &= "from import_document d "
            strsql &= "where d.doc_id='" & K2 & "' and d.active=1 and d.secret=0 "
            ...
            For Each dr As DataRow In dt.Rows
                ...
                Dim strUrlFile As String = "OpenDoc.aspx?url=http://" & Constant.BaseURL(Request) & dr("file_path").ToString() & ""

                lblLinkFile.Text = "<a href='" & strUrlFile & "&type=" & dr("doc_type").ToString() & "&subtype=" & dr("doc_subtype").ToString() & "' Target='_Blank'>" & dr("doc_name").ToString() & "</a>&nbsp;&nbsp;"
    ...
    Protected Sub gDetail_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gDetail.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lblLinkFile As LinkButton = e.Row.Cells(0).FindControl("lblLinkFileDetail")
            ...
            For Each dr As DataRow In dt.Rows
                ...
                lblLinkFile.Text = "<a href='" & strUrlFile & "&type=" & dr("doc_type").ToString() & "&subtype=" & dr("doc_subtype").ToString() & "' Target='_Blank'>" & dr("doc_name").ToString() & "</a>&nbsp;&nbsp;"
                lblLinkDownload.Text = "<a href='" & strUrlFile & "&type=" & dr("doc_type").ToString() & "&subtype=" & dr("doc_subtype").ToString() & "' Target='_Blank'><img src='Images/Ipdf.jpg' border=0></a>&nbsp;&nbsp;"
